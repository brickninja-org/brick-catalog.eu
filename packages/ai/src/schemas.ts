...
export const highlightSchema = z.object({
  ...
  label: z.string().describe('Short label, e.g. "Elements Lead"'),
  detail: z.string().describe('Context, e.g. "2,081 elements registered"'),
});
...
export const postSchema = z.object({
  ...
  highlights: z
    ...
    .min(3)
    .max(3)
    .describe('Exactly 3 key statistics for visual display'),
});
